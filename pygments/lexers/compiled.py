    ...
    class GeneratedObjectiveCVariant(baselexer):
        ...
        tokens = {
            'statements': [
                ...
                (r'@\(.+\)', Number),
                (r'(in|out|inout|@selector|@private|@protected|@public|@encode|'
                 r'@synchronized|@try|@throw|@catch|@finally|@end|@property|'
                 r'__bridge|__bridge_transfer|__autoreleasing|__block|__weak|__strong'
                 r'weak|strong|retain|assign|unsafe_unretained|'
                 r'nonatomic|readonly|readwrite|setter|getter|typeof'
